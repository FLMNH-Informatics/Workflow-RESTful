...
ActiveRecord::Schema.define(:version => 20121211161900) do
  ...
  create_table "bacs", :force => true do |t|
    t.string   "value"
    t.integer  "sequence_contig_id"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "z_file_id"
    t.integer  "chr_image_id"
    t.integer  "project_id",         :null => false
  end

  create_table "bacs_chr_images", :id => false, :force => true do |t|
    t.integer "bac_id"
    t.integer "chr_image_id"
  end

  create_table "bacs_images", :id => false, :force => true do |t|
    t.integer "bac_id"
    t.integer "image_id"
  end

  create_table "biodatabase", :id => false, :force => true do |t|
  ...
  create_table "bioentry", :id => false, :force => true do |t|
  ...
  create_table "bioentry_relationship", :id => false, :force => true do |t|
    t.integer "bioentry_relationship_id", :null => false
    t.integer "object_bioentry_id",       :null => false
    t.integer "subject_bioentry_id",      :null => false
    t.integer "term_id",                  :null => false
    t.integer "rank"
  ...
  create_table "characters_chr_groups", :id => false, :force => true do |t|
  ...
  create_table "characters_matrices", :id => false, :force => true do |t|
    t.integer "character_id"
    t.integer "matrix_id"
    t.integer "position"
    t.boolean "updated"
...
#   Unknown type 'direction' for column 'long_dir'
  ...
  create_table "contigs_probes", :id => false, :force => true do |t|
    t.integer "sequence_contig_id"
    t.integer "probe_id"
  end
  ...
  create_table "dbxref", :id => false, :force => true do |t|
    t.integer "dbxref_id",                :null => false
  ...
  create_table "dna_samples", :id => false, :force => true do |t|
    t.integer "id",                  :limit => 8,                  :null => false
...
#   Unknown type 'publication_type' for column 'publication_type'
  ...
  create_table "matrices_otus", :id => false, :force => true do |t|
    t.integer "otu_id"
    t.integer "matrix_id"
    t.integer "position"
    t.boolean "new_flag"
  ...
  create_table "ontology", :id => false, :force => true do |t|
  ...
  create_table "otu_groups_otus", :id => false, :force => true do |t|
    t.integer  "otu_id"
    t.integer  "otu_group_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "permission_set_vtattrs", :id => false, :force => true do |t|
  ...
  create_table "permission_vtattrs", :id => false, :force => true do |t|
    t.integer "vtid",                :limit => 8, :null => false
  ...
  create_table "probes_bacs", :id => false, :force => true do |t|
    t.integer "probe_id"
    t.integer "bac_id"
  end

  create_table "probes_dye_compositions", :id => false, :force => true do |t|
    t.integer "probe_id"
    t.integer "dye_composition_id"
  end
  ...
  create_table "probes_seqs", :id => false, :force => true do |t|
    t.integer "probe_id"
    t.integer "insd_seq_id"
  end

  create_table "probes_zfiles", :id => false, :force => true do |t|
    t.integer "probe_id"
    t.integer "z_file_id"
  end
  ...
  create_table "project_vtattrs", :id => false, :force => true do |t|
    t.integer "vtid",    :limit => 8, :null => false
    t.string  "label",                :null => false
    t.string  "logo"
    t.string  "website"
  ...
  create_table "property_vtattrs", :id => false, :force => true do |t|
    t.integer "vtid",  :limit => 8, :null => false
    t.string  "label",              :null => false
  end
  ...
  create_table "publisher_sources", :id => false, :force => true do |t|
    t.integer  "id",         :null => false
    t.string   "name"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "role_member_users", :id => false, :force => true do |t|
    t.integer  "statement_id",              :limit => 8, :null => false
    t.integer  "rtid",                      :limit => 8, :null => false
    t.integer  "vtid",                      :limit => 8, :null => false
  ...
  create_table "role_vtattrs", :id => false, :force => true do |t|
    t.integer "vtid",  :limit => 8, :null => false
    t.string  "label",              :null => false
  end
  ...
  create_table "rsattrs", :id => false, :force => true do |t|
    t.integer  "rtid",                      :limit => 8, :null => false
  ...
  create_table "seqfeature", :id => false, :force => true do |t|
    t.integer "seqfeature_id",                                      :null => false
    t.integer "bioentry_id",                                        :null => false
  ...
  create_table "seqfeature_relationship", :id => false, :force => true do |t|
    t.integer "seqfeature_relationship_id", :null => false
    t.integer "object_seqfeature_id",       :null => false
    t.integer "subject_seqfeature_id",      :null => false
    t.integer "term_id",                    :null => false
    t.integer "rank"
  ...
  create_table "statement_vtattrs", :id => false, :force => true do |t|
    t.integer "vtid",      :limit => 8, :null => false
    t.integer "subj_rtid", :limit => 8, :null => false
    t.integer "prop_rtid", :limit => 8, :null => false
    t.integer "obj_rtid",  :limit => 8, :null => false
  ...
  create_table "taxa", :id => false, :force => true do |t|
    t.integer  "taxon_id",                  :limit => 8,                      :null => false
    t.integer  "rtid",                      :limit => 8,                      :null => false
    t.integer  "vtid",                      :limit => 8,                      :null => false
    t.integer  "owner_user_rtid",           :limit => 8,                      :null => false
    t.integer  "owner_record_rtid",         :limit => 8,                      :null => false
  ...
  create_table "taxon", :id => false, :force => true do |t|
    t.integer "taxon_id",                        :null => false
  ...
  create_table "taxon_vtattrs", :id => false, :force => true do |t|
    t.integer  "vtid",                    :limit => 8,                      :null => false
    t.string   "name",                                                      :null => false
    t.string   "author"
    t.string   "year"
  ...
  create_table "term", :id => false, :force => true do |t|
    t.integer "term_id",                   :null => false
    t.string  "name",                      :null => false
    t.text    "definition"
    t.string  "identifier",  :limit => 40
  ...
  create_table "term_path", :id => false, :force => true do |t|
    t.integer "term_path_id",      :null => false
  ...
  create_table "term_relationship", :id => false, :force => true do |t|
  ...
  create_table "user_vtattrs", :id => false, :force => true do |t|
    t.integer "vtid",            :limit => 8,                     :null => false
  ...
  create_table "vsattrs", :id => false, :force => true do |t|
    t.integer  "vtid",         :limit => 8, :null => false
    t.integer  "rtid",         :limit => 8, :null => false
    t.integer  "creator_rtid", :limit => 8, :null => false
    t.integer  "deleter_rtid", :limit => 8
...
#   Unknown type 'workflow_status' for column 'status'
  ...
  create_table "wtasks", :force => true do |t|
    ...
    t.datetime "updated_at"
    t.string   "name"
    t.string   "wtask_status"
    t.string   "wtask_folder"
  end
  ...
  create_table "zfiles_images", :id => false, :force => true do |t|
    t.integer "z_file_id"
    t.integer "chr_image_id"
  end
